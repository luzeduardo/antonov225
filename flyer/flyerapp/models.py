...
class Schedule(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, null=False)
    price_percent_lower = models.DecimalField(max_digits=2, decimal_places=1, null=False)
    ...
    url_acess = models.TextField()
    email = models.CharField(max_length=80)
    pub_date = models.DateTimeField('date published')

class PossibleFlights(models.Model):
    schedule = model.ForeignKey(Schedule, related_name="schedule_schedule")
    pub_date = models.DateTimeField('date published')    